...
SCREEN_W = 800
SCREEN_H = 600
X_LOCATION = 460		#to display track's name
...
class MusicPlayerMain < Gosu::Window
	...
	# Read a single album
	def read_album()
		a_file = File.new("read_music.txt", "r")
	...
	def draw_albums(albums)
		@album.artwork.draw(30, 60 , z = ZOrder::PLAYER, 0.3, 0.3)
	...
	def draw_current_playing(idx)
		draw_rect(@album.tracks[idx].dim.leftX - 10, @album.tracks[idx].dim.topY, 5 , @track_font.height(), Gosu::Color::YELLOW, z = ZOrder::PLAYER)
	end
 ...
 def display_track(track)
	 @track_font.draw_text(track.name, X_LOCATION, track.dim.topY, 1, 1.0, 1.0, Gosu::Color::BLACK)
	end
